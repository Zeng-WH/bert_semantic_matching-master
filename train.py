...
def main(args):
    ...
    #vocab = Vocabulary.from_files('/home1/CM2021/lym/QAbaseline/bert-base-chinese/vocab.txt')
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--config_path", type=str, default="./config/bert.lcqmc.json",
